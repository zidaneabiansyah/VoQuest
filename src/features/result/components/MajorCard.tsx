...
export function MajorCard({ recommendation, isPrimary = false }: MajorCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Salary Info */}
      <div className="grid grid-cols-3 gap-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg relative z-10">
        <div>
      ...
      {isPrimary && (
        <motion.div
          ...
          className="mt-6 p-4 bg-primary/10 rounded-lg border border-primary/20 relative z-10"
        >
